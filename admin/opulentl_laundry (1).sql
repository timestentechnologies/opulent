...
(1, 'admin', 'mokayageofrey5@gmail.com', '3e47ffcae510de1ac003964c3de50a8989f2cddbbe7c8c10a0ecac7cd447d239', 'Timesten ', 'Kenya', 'Male', '2018-11-26', '9423979339', 'Nashik', 'unr_harrypotter_171212_1815_34k5k.png', '2018-04-30', 1);
...
(3, 'timestenkenya@gmail.com', '$2y$10$58DIkalw4/xVMUSIuO7AwOJcsosZcMdmzUjOPdk4TwAC9RlG/A7h6', 'Timesten', 'Kenya', '09423979339', 'tnnbtrgfv', '54545', '32d', '54545', '2025-04-09 12:49:43', '2025-05-11 06:23:28', 'active'),
(10, 'franklinareba13@gmail.com', '$2y$10$6X4k5LIwtC5eWVIqThKyE.RZNS8SkGhZbuT1gVLvCUfU3HoUoSMvy', 'Franklin', 'Areba', '+254713018243', 'Donholm', 'Nairobi', 'Nairobi', '00100', '2025-04-23 17:15:46', '2025-04-30 11:10:27', 'active'),
(11, 'chombaalex2019@gmail.com', '$2y$10$p.00RdVLOo2tEosQYNhNbuYFvf81s68W843G0hGiC/Mvbcg1gHI2y', 'Timesten', 'Kenya', '09423979339', 'tnnbtrgfv', '54545', 'jkjk', '54545', '2025-04-27 18:06:38', '2025-04-30 05:41:35', 'active'),
(12, 'mokayageofrey5@gmail.com', '$2y$10$Pb8AhSoFkCJrFno5S87HLe6a792LbLfGSQkvGQ./Mrv4mU3lau2Ca', 'Geofrey', 'Mokaya', '0728441514', '+254728441514', 'Nairobi', 'mlolongo', '40200', '2025-05-01 08:03:31', NULL, 'active'),
(13, 'kenya@gmail.com', '$2y$10$3FsAayUzOVB/uQ4J3YHif.dqG.HIcopW.U9lrnj4PTrurM7kEgb22', 'Geofrey', 'Mokaya', '0728441514', '+254728441514', 'Kisii', 'nh', '40200', '2025-05-07 06:25:56', '2025-05-08 05:40:13', 'active');
...
(6, 'timestenkenya@gmail.com', '2025-04-23 07:49:41'),
(7, 'medservsupplies@gmail.com', '2025-04-23 08:41:02'),
(8, 'timestenkeny@gmail.com', '2025-04-28 18:52:32'),
(9, 'mokayageofrey5@gmail.com', '2025-05-01 08:02:26');
...
INSERT INTO `inquiries` (`id`, `name`, `phone`, `email`, `message`, `response`, `status`, `created_at`, `updated_at`, `customer_id`) VALUES
(17, 'Geofrey Mokaya', '0728441514', 'mokayageofrey5@gmail.com', 'tythtjty', 'hhhhhh', 'closed', '2025-05-01 08:15:22', '2025-05-04 11:38:01', 12);
...
INSERT INTO `order` (`id`, `customer_id`, `service_id`, `description`, `price`, `weight`, `pickup_date`, `delivery_date`, `status`, `created_at`, `updated_at`, `notes`, `payment_status`, `payment_method`, `tracking_number`, `mpesa_code`, `mpesa_number`) VALUES
(130, 3, 19, 'bmhjhgj', 1155.00, 7, '2025-05-14', '2025-06-07', 'received', '2025-05-11 07:39:27', '2025-05-11 07:39:27', NULL, '', NULL, 'OPL250511661130', '', 0);
...
(4, '1–4 kg Wash, Dry & Fold', '125'),
(19, '1–4 kg Wash, Dry, Iron & Fold ', '165'),
(21, 'Wash, Dry & Fold 5 kg and above', '100'),
(23, 'Wash, Dry, Iron & Fold 5 kg and above', '140'),
(25, ' Ironing Only (standalone) Per item', '60'),
(27, 'Add-on Express Same-Day Service  ', '300'),
(29, 'Bedsheets & Pillowcases', '120'),
(31, 'Duvets (All Sizes)', '500'),
(33, 'Blankets (Light/Medium)', '400'),
(35, 'Blankets (Heavy/Thick) ', '700'),
(37, 'Curtains', '150'),
(41, 'Cushion/Seat Covers 6-piece set', '250'),
(43, 'Baby Clothes', '100'),
(45, 'Shoes (Sneakers/Canvas)', '150'),
(46, 'Wedding Gown', '3000'),
(47, 'Suit Dry Cleaning', '600'),
(48, 'Graduation Gown', '700'),
(49, 'Delicate Garments (Silk, Lace, Chiffon) ', '150'),
(50, 'Stain Removal', '50');
...
(1, '<Opulent  Laundry> ', 'smtp.gmail.com', 587, 'timestenkenya@gmail.com', 'ycyo qjjd hbyr shbq', 'tls');
...
INSERT INTO `user_subscriptions` (`id`, `customer_id`, `plan_id`, `start_date`, `end_date`, `status`, `created_at`, `mobile`, `code`) VALUES
(3, 10, 1, '2025-04-23', '2025-05-23', 'active', '2025-04-23 17:16:48', NULL, NULL),
(4, 3, 2, '2025-04-24', '2025-05-24', 'active', '2025-04-24 07:21:29', NULL, NULL),
(5, 11, 1, '2025-04-27', '2025-05-27', 'pending', '2025-04-27 18:06:51', NULL, NULL);
