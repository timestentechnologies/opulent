          ...
          <div class="login-content card">
            <div class="login-form">
              ...
              <div class="d-flex justify-content-center gap-2 m-t-15">
                <a href="forgot_password.php" class="btn btn-secondary btn-flat btn-sm" style="background-color: #6c757d; border-color: #6c757d; color: #fff; padding: 6px 12px; font-size: 13px;">Back</a>
