...
<tbody>
<?php 
// Get pending orders with customer and service information in a single query
...
<a href="pending_order.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
</td>
</tr>
<?php 
    }
